...
import { createDepartmentsAsync} from '../../Redux/reducers/emsReducer';
...
export default function DepForm (){
    ...
    const schema = yup.object().shape({
        ...
        description:yup.string().required("Enter description ").min(15).max(100),
        salary_range:yup.string().required('enter salary').min(1).max(30),
      });
    ...
    // }
        ...
        return (
            <div className="flex flex-col justify-center  items-center  bg-opacity-30 px-10">
                <div className="grid"><p className=" text-black font-bold text-2xl mt-10" >Create New Department</p></div>
                <Formik 
                    initialValues={{name:'',description:'',salary_range:''}}
                    ...
                    onSubmit={(values, actions) => {
                        ...
                        dispatch(createDepartmentsAsync(data)).then((value)=>console.log(value));
                        // Signup(data)
                        actions.resetForm();
                    }}
                    ...
                    {({
                        ...
                        <form className="bg-gray-200 shadow rounded px-4 pt-6 pb-8  my-10 w-1/2 " onSubmit={handleSubmit}>
                            ...
                            text-gray-700 mb-3 leading-tight focus:outline-black"
                                ...
                                />
                                <h6 className="text-red-600 text-sm font-bold">{errors.salary_range && touched.salary_range && errors.salary_range}</h6>
                            </div>
