   ...
   // const [departments,setDep] = useState([])
    ...
    return (
        ...
        <div className="relative h-14 w-full items-end ">
            <button onClick={() => { navigate('/salaryform', { state: { id: 7,flag:"edit"} }); }} className=' absolute top-10 right-14 bg-green-500 hover:text-blue-400 outline-black text-white font-semibold 
