...
import { LOGIN } from '../../EMS/services/services';
import { EMAIL_KEY, ID_KEY, ROLE_KEY, TOKEN_KEY } from '../../../constants/constant';
        ...
        return (
            <div className="flex flex-col justify-center  items-center ">
                <div className="mt-14 w-1/2">
                    <h3 className="mx-28 px-14">Employee Management System</h3>
                </div>
                <div className=" w-1/2 ">
                <Formik
                ...
                >
                    ...
                    <button onClick={()=>{
                        navigate('./forgetpass')
                    }} className=" text-s p-2 text-blue-500 hover:text-blue-900" >
                       Forget Password
                    </button>
